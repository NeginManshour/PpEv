...
# This code is a slightly modified version of `fix_numbering.pl` from DockQ.
# The original can be found at https://github.com/bjornwallner/DockQ
...
# Output file is the original filename with '.pdb' added to the end
open(OUT,">$pdb_model.pdb"); 
while(<MODEL>) {
 #   print "A: ";
  #  print;
    if(/^ATOM/) {
