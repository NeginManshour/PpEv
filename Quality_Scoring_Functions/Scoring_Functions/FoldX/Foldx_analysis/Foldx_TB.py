...
output_dir = os.path.join(config["output_directory"], "foldx_TB_Dock")
...
input_directory = os.path.join(config['output_directory'], 'foldx_TB_Dock')
output_directory = os.path.join(config['output_directory'], 'alphafold_rank_Foldx_TB')
...
# Example usage
input_directory = os.path.join(config['output_directory'], 'alphafold_rank_Foldx_TB')
output_directory = os.path.join(config['output_directory'], 'stability_TB')
...
source_directory = os.path.join(config['output_directory'], 'alphafold_rank_Foldx_TB')
output_directory = os.path.join(config['output_directory'], 'interaction_TB')
...
directory = os.path.join(config['output_directory'], 'interaction_TB')
...
# Example usage
directory_path = os.path.join(config['output_directory'], 'stability_TB')
...
output_directory = config['Spearman_Correlation_directory_TB']
file_name = 'correlations_stability_TB.xlsx'
...
output_path = os.path.join(config['DockQ_Loss_directory_TB'], 'Foldx_stability_TB.xlsx')
...
# Example usage
directory_path = os.path.join(config['output_directory'], 'interaction_TB')
output_directory = config['Spearman_Correlation_directory_TB']
process_excel_files(directory_path, output_directory)
...
output_directory = config['Spearman_Correlation_directory_TB']
file_name = 'correlations_Interaction_TB.xlsx'
file_path = os.path.join(output_directory, file_name)
...
output_path = os.path.join(config['DockQ_Loss_directory_TB'], 'Foldx_Interaction_TB.xlsx')
results_df.to_excel(output_path, index=False)
