...
# Example usage
input_subfolder = 'Vina_TF_ex'  # Subfolder name where the Excel files are located
output_subfolder = 'Vina_TF_ex_sorted'  # Subfolder name where sorted Excel files will be saved
...
# Example usage
input_subfolder = 'Vina_TF_ex_sorted'  # Subfolder name where the Excel files are located
output_subfolder = 'Vina_sorted_TF_alpha_rank'  # Subfolder name where processed Excel files will be saved
...
vina_dir = os.path.join(config['output_directory'], 'Vina_sorted_TF_alpha_rank')
output_dir = os.path.join(config['output_directory'], 'vina_DockQ_TF')
...
def process_excel_files(directory_path, output_directory):
    ...
    output_file_path = os.path.join(output_directory, 'correlations_vina_TF.xlsx')
...
# Example usage
directory_path = os.path.join(config['output_directory'], 'vina_DockQ_TF')
...
# Example usage
output_directory = config['Spearman_Correlation_directory_TF']
file_name = 'correlations_vina_TF.xlsx'
...
output_path = os.path.join(config['DockQ_Loss_directory_TF'], 'Vina_loss_TF.xlsx')
